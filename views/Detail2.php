...
<body>
    ...
    <div class="container sproduct mt-5 mb-5">
        <div class="row">
            <div class="col">
                <div class="slider">
                    <div class="product">
                        <img src="<?= base_url() ?>assets/img/produkk1.png" alt="" onclick="clickme(this)">
                        <img src="<?= base_url() ?>assets/img/produkk2.png" alt="" onclick="clickme(this)">
                        <img src="<?= base_url() ?>assets/img/produkk3.png" alt="" onclick="clickme(this)">
                        <img src="<?= base_url() ?>assets/img/produkk4.png" alt="" onclick="clickme(this)">
                    </div>
                    <div class="preview">
                        <img src="<?= base_url() ?>assets/img/produkk1.png" id="imagebox" alt="">
                    </div>
                </div>
            </div>
            ...
            <div class="col">
                <div class="content">
                    ...
                    <h2>HS70 Wired Gaming Headset with Bluetooth</h2>
                    <div class="rating ">
                    ...
                    <h2>Rp 2.400.000</h2>
                    <span>CORSAIR HS70 BLUETOOTH Gaming Headset menghadirkan kenyamanan dan kualitas dengan bantalan telinga busa memori, driver audio neodymium 50mm yang disesuaikan, dan koneksi kabel simultan untuk audio game dengan Bluetooth® untuk mengobrol.</span>
                    <p></p>
    ...
    <div class="related ">
        ...
        <div class="row">
            <div class="columns">
                <div class="items">
                    <img src="<?= base_url() ?>assets/img/produkk5.png" alt="">
                    <div class="details">
                        <p>HS70 SE WIRELESS Gaming Headset (CN)</p>
                        <div class="rating">
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
            ...
            <div class="columns">
                <div class="items">
                    <img src="<?= base_url() ?>assets/img/produkk6.png" alt="">
                    <div class="details">
                        <p>HS70 WIRELESS Gaming Headset — White (AP)</p>
                        <div class="rating">
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
            ...
            <div class="columns">
                <div class="items">
                    <img src="<?= base_url() ?>assets/img/produkk7.png" alt="">
                    <div class="details">
                        <p>ST100 RGB Premium Headset Stand with 7.1 Surround Sound (AP)</p>
                        <div class="rating">
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
            ...
            <div class="columns">
                <div class="items">
                    <img src="<?= base_url() ?>assets/img/produkk8.png" alt="">
                    <div class="details">
                        <p>Uni-Directional Microphone for VIRTUOSO RGB Wireless</p>
                        <div class="rating">
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
                            <i class="fa fa-star"></i>
