	...
	<body>
		...
		<header>
			...
			<nav>
				<ul class="navbar">
					<li><a href="">Home</a></li>
					<li><a href="c_Profile">Profile</a></li>
					<li><a href="c_Cart">Cart</a></li>
					<li><a href="c_Login">Sign In</a></li>
					<li><a href="c_List">List Produk</a></li>
				</ul>
			</nav>
		...
		<h1 class="h">HOT PRODUCTS</h1><br>
			...
			<div class="carousel" data-flickity>
				<div><a href="#"><img src="assets\img\sl-mouse.jpg" class="carousel-cell"></a></div>
				<div><a href="#"><img src="assets\img\sl-keyboard.jpg" class="carousel-cell"></div>
				<div><a href="c_Detail2"><img src="assets\img\sl-headset.jpg" class="carousel-cell"></div>
				<div><a href="#"><img src="assets\img\sl-controller.jpg" class="carousel-cell"></div>
			</div>
			<hr>
		<div>
